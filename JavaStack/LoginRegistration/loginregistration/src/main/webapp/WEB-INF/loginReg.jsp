...
<%
    String[] states = {"AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY", "AS", "DC", "GU", "MP", "PR", "VI"};
                                ...
                                <div class="card-body">
                                    <form:form action="/" method="POST" modelAttribute="user">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <form:input type="text" class="form-control w-50" path="city" placeholder="City" minlength="4"/>

...
<div class="container">
    <hr class="my-4">
    <div class="row">
        <div class="col-3 d-inline-block lead">Songs by Artist: <c:out value="${artist}"/></div>
        <div class="col-1"></div>
        <form action="/search" method="post" class="d-inline-block form-inline">
            <div class="col d-inline-block ml-5">
                <input name="artist" type="text" class="form-control" value=" ">
                <button type="submit" class="btn btn-primary">New Search</button>
            </div>
        </form>
        <div class="col-2 ml-3"></div>
        <div class="col-1 ml-4"><a href="/dashboard">Dashboard</a></div>
    </div>
    <hr class="my-4">
